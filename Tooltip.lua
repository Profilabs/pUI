...
local cfg = {}
cfg.pos = { "BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -120, 240 }
...
local function OnTooltipSetUnit(self)
  ...
  if not UnitIsPlayer(unit) then
    ...
    elseif unitClassification == "rare" then
      self:AppendText(" |TInterface\\TargetingFrame\\UI-TargetingFrame-Skull:14:14|t")
      --self:AppendText(" |TInterface\\AddOns\\rufioMedia\\tex:14:14:0:0:16:16:0:14:0:14|t")
...
GameTooltipHeaderText:SetFont(cfg.fontFamily, 15, "NONE")
GameTooltipHeaderText:SetShadowOffset(1,-1)
GameTooltipHeaderText:SetShadowColor(0,0,0,0.9)
GameTooltipText:SetFont(cfg.fontFamily, 13, "NONE")
...
GameTooltipStatusBar:SetPoint("BOTTOM",0,-8)
...
GameTooltipStatusBar:SetScript("OnValueChanged", function(self, value)
    ...
    if unit then
        ...
        if not self.text then
            ...
            self.text:SetFont(cfg.fontFamily, 13, "THINOUTLINE")
        end
        self.text:Show()
