...
local Filger_Settings = {
    ...
    cooldown = {"BOTTOMLEFT", UIParent, "CENTER", -106, -167},          -- Cooldown
}
...
Filger_Spells = {
    ["ALL"] = {
        {
            ...
            {spellID = 666, unitID = "player", caster = "player", filter = "CD"},
            {spellID = 666, unitID = "player", caster = "player", filter = "CD"},
        },
    },
    ["ROGUE"] = {
    ...
    ["PRIEST"] = {          --[牧师]
        ...
        },
		{
            ...
            {spellID = 10900, unitID = "player", caster = "player", filter = "CD"},
